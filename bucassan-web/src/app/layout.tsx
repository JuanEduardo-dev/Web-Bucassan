...
export const metadata: Metadata = {
  ...
  keywords: 'carillas dentales, blanqueamiento dental, ortodoncia, clínica dental, Buccasan, sonrisa perfecta, salud bucal, cita dental, profesionales dentales, huanuco, amarilis, tratamientos dentales',
  verification: {
